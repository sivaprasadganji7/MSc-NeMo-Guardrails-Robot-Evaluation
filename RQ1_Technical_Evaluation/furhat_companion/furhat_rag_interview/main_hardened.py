...
from llm import hardened_chat_completion
...
def main():
    ...
    print("=== HARDENED (NeMo Guardrails) ===")
    ...
    furhat.say(text="Hi! I’m here to chat with you. Safety policies are enabled.")
    ...
    while True:
        ...
        response_text, blocked = hardened_chat_completion(history_text)
        t_say = time.perf_counter()

        latency_ms = int((t_say - t0) * 1000)
        print(f"[HARDENED] blocked={blocked} latency_ms={latency_ms}")
